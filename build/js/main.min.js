...
/* harmony import */ var _modules_accordion_spoiler__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/accordion/spoiler */ "./js/modules/accordion/spoiler.js");
/* harmony import */ var _modules_update_text_content_update_text_content__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/update-text-content/update-text-content */ "./js/modules/update-text-content/update-text-content.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    ...
    Object(_modules_accordion_spoiler__WEBPACK_IMPORTED_MODULE_4__["initSpoiler"])();
    Object(_modules_update_text_content_update_text_content__WEBPACK_IMPORTED_MODULE_5__["updateTextContent"])();
  });
});
...
var initSpoiler = function initSpoiler() {
  var parentElement = document.querySelector('[data-spoiler="parent"]');
  if (parentElement) {
    var btnElement = parentElement.querySelector('[data-accordion="button"]');
    if (btnElement) {
      var spoilerBtnToggler = function spoilerBtnToggler() {
...
/*!***************************************************************!*\
  !*** ./js/modules/update-text-content/update-text-content.js ***!
  \***************************************************************/
/*! exports provided: updateTextContent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var updateTextContent = function updateTextContent() {
  var updateText = function updateText(width, selector, newText) {
    var breakpoint = window.matchMedia("(max-width:".concat(width, "px)"));
    var TextEl = document.querySelector("[".concat(selector, "]"));
  ...
  updateText(767, 'data-text="catalog-title"', "\u0422\u043E\u0432\u0430\u0440\u044B \u0438\xA0\u0443\u0441\u043B\u0443\u0433\u0438 Smart\xA0Device");
};
